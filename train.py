...
max_iters = 37000 # total number of training iterations
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
lr_decay_iters = 37000 # should be ~= max_iters per Chinchilla
...
if init_from == 'scratch':
    ...
    model_args['vocab_size'] = meta_vocab_size if meta_vocab_size is not None else 132
